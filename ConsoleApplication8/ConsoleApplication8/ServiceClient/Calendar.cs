...
{
    internal partial class Calendar : IServiceOperations<ServieClient>, ICalendar
    {
        /// <summary>
        ...
        /// </param>
        internal Calendar(ServieClient client)
        {
            this._client = client;
        }
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> GetWithOperationResponseAsync(GetCalendarRequest calendarRequest, string trackingId, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (calendarRequest == null)
            {
                throw new ArgumentNullException("calendarRequest");
            }
            if (trackingId == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("calendarRequest", calendarRequest);
            ...
            JToken requestDoc = calendarRequest.SerializeJson(null);
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<string>> PostWithOperationResponseAsync(CreateCalendarRequest calendarRequest, string trackingId, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Validate
            if (calendarRequest == null)
            {
